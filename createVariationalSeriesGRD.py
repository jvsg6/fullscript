...
patToFIdir = "/home/egor/allskript/FI/"
pathToSIdir = str(sys.argv[1])
vib = sys.argv[2]
...
def main():
	...
	for fileName in listOfFiles:
		...
		posOf95Pbase = int(ceil(float(gridsCount)*float(vib)))-1 #номер сетки превращаем в позицию сетки т.е. -1
